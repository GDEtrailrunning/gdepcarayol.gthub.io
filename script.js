...
const dataLine1 = {
  labels: ['Día 1', 'Día 2', 'Día 3', 'Día 4'], // Etiquetas de los días], // Etiquetas de los días], // Etiquetas de los días
  datasets: [{
    label: 'Km recorridos en Semana 10',
    data: [5, 5, 7, 12], // Datos de los km recorridos en cada día
...
const dataLine2 = {
  ...
  datasets: [{
    ...
    data: [9, 10, 8, 16, 18], // Datos de los km recorridos en cada día
