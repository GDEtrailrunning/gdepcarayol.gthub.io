...
const dataLine1 = {
  ...
  datasets: [{
    ...
    data: [12, 11, 11, 12, 14], // Datos de los km recorridos en cada día
...
const dataLine2 = {
  ...
  datasets: [{
    ...
    data: [10, 8, 10, 10, 9], // Datos de los km recorridos en cada día
...
function actualizarDiasRestantes() {
  // Fecha objetivo fija
  const objetivoDate = new Date('2026-04-08');
