...
const dataLine1 = {
  labels: ['Día 1', 'Día 2', 'Día 3', 'Día 4', 'Día 5'], // Etiquetas de los días], // Etiquetas de los días], // Etiquetas de los días
  datasets: [{
    label: 'Km recorridos en Semana 4',
    data: [15, 17, 21, 16, 22], // Datos de los km recorridos en cada día
...
const dataLine2 = {
  ...
  datasets: [{
    ...
    data: [14, 22, 19, 13, 20], // Datos de los km recorridos en cada día
...
function actualizarDiasRestantes() {
  // Fecha objetivo fija
  const objetivoDate = new Date('2026-02-14');
